...
- 반응형: 360px 모바일 카드 1열+햄버거, 768px 태블릿 내비 펼침+기술 2열+카드 auto-fit 확장, 1024px 최대폭 1024px 중앙+기술 4열, 1200px 최대폭 1200px+카드 4열 명시 고정. 버튼·카드는 `hover`+`transition`, 입체감은 `box-shadow`. 아래 스크린샷 참고.
